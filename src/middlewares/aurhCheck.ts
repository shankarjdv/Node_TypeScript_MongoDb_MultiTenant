...
type SigningKeyResolver = (header: JwtHeader, callback: SigningKeyCallback) => void;
...
export const verifyToken = (req: CustomRequest, res: Response, next: NextFunction) => {
    ...
    const getKey: SigningKeyResolver = (header: JwtHeader, callback: SigningKeyCallback) => {
    ...
    jwt.verify(token, getKey, (err, decoded) => {
        ...
        if (tenantList.some((tenant: ITenant) => tenant.tenantId === decoded?.tid)) {
